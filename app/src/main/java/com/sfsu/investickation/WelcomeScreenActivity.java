...
public class WelcomeScreenActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pager = (ViewPager) findViewById(R.id.welcome_screen_pager);
    ...
    private void setIndicator(int index) {
        if (index < TOTAL_PAGES) {
            for (int i = 0; i < TOTAL_PAGES - 1; i++) {
                ...
                if (i == index) {
                    circle.setColorFilter(getResources().getColor(R.color.colorBlack));
                } else {
                    circle.setColorFilter(getResources().getColor(R.color.colorWhite));
                }
            }
        }
    }
